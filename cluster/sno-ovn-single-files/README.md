# SNO with OVNKubernetes CNI and single interface
...
Define the redfish credentials for servers. You can also keep redfish credentials in server.json

```
[
    {
        "hostname": "my-cluster-node",        "redfish": {
